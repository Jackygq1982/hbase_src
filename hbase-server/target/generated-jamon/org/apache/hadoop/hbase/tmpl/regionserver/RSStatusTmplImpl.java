...
// /home/hbase/hbase-0.98.8/hbase-server/src/main/jamon/org/apache/hadoop/hbase/tmpl/regionserver/RSStatusTmpl.jamon
...

{
  ...
  ServerName masterServerName = masterAddressTracker == null ? null
    ...
    // 107, 5
    {
      ...
      __jamon__var_8.renderNoFlush(jamonWriter, regionServer.getMetrics().getRegionServerWrapper());
    }
    // 107, 89
    jamonWriter.write("\n    </section>\n\n    <section>\n    ");
    // 111, 5
